...
\* \*\*Atacante (Red Team):\*\* Kali Linux (IP: `Insira\_o\_IP\_aqui`)

\* \*\*Vítima (Blue Team):\*\* Ubuntu Server (IP: `Insira\_o\_IP\_aqui`)
...
| \*\*Endereço IPv4\*\* | `IP\_do\_Atacante` | Origem do ataque de força bruta |
